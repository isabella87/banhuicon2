namespace Banhuitong.Console {
    partial class CrmNewRegsFrm {
        ...
        private void InitializeComponent() {
            ...
            this.btnSearch.ToolTipText = "查询(&S)";
            ...
            // startDate
            // 
            this.startDate.CustomFormat = "yyyy年MM月";
            this.startDate.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
            this.startDate.Location = new System.Drawing.Point(40, 28);
            this.startDate.Name = "startDate";
            this.startDate.ShowUpDown = true;
            this.startDate.Size = new System.Drawing.Size(80, 21);
            this.startDate.TabIndex = 2;
            // 
            // myGridViewBinding1
            // 
            this.myGridViewBinding1.Columns.AddRange(new MyLib.UI.MyGridColumn[] {
            new MyLib.UI.MyGridColumn("auId", "客户ID", MyLib.UI.MyGridColumnType.Number, 50, false, true),
            new MyLib.UI.MyGridColumn("realName", "姓名", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            new MyLib.UI.MyGridColumn("mobile", "手机号码", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            new MyLib.UI.MyGridColumn("company", "工作单位", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            new MyLib.UI.MyGridColumn("position", "职务", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            new MyLib.UI.MyGridColumn("city", "城市", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            new MyLib.UI.MyGridColumn("age", "年龄", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            new MyLib.UI.MyGridColumn("gender", "性别", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            new MyLib.UI.MyGridColumn("remark", "备注", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            new MyLib.UI.MyGridColumn("recommendMobile", "推荐码", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            ...
            this.Name = "CrmNewRegsFrm";
            this.ShowIcon = false;
            this.Text = "客户管理-新增注册用户";
            this.Load += new System.EventHandler(this.FrmCrmNewRegs_Load);
