namespace Banhuitong.Console {
    partial class AccInvestDepositoryDlg {
        /// <summary>
        ...
        private void InitializeComponent() {
            ...
            new MyLib.UI.MyGridColumn("productId", "产品编号", MyLib.UI.MyGridColumnType.Text, 100, false, true),
            new MyLib.UI.MyGridColumn("orderId", "订单号", MyLib.UI.MyGridColumnType.Text, 220, false, true),
            new MyLib.UI.MyGridColumn("buyDate", "投标日期", MyLib.UI.MyGridColumnType.Date, 80, false, true),
            new MyLib.UI.MyGridColumn("txAmount", "金额(元)", MyLib.UI.MyGridColumnType.Money, 120, false, true),
            new MyLib.UI.MyGridColumn("state", "状态", MyLib.UI.MyGridColumnType.Text, 120, false, true)});
            ...
            this.Name = "AccInvestDepositoryDlg";
            this.ShowIcon = false;
            this.Text = "投标记录(存管)-{0}";
            this.Load += new System.EventHandler(this.AccInvestDepositoryDlg_Load);
