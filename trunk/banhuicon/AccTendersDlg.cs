...
namespace Banhuitong.Console {
    ...
    public partial class AccTendersDlg : Form {
        ...
        public AccTendersDlg(long auId) {
            InitializeComponent();
            m_auId = auId;
        }

        private void AccTendersDlg_Load(object sender, EventArgs e) {
        ...
        private async void UpdateTable() {
            ...
            var p = await InvestBase.Tenders(d);
            if (p.IsOk) {
