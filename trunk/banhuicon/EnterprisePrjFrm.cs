    ...
    public partial class EnterprisePrjFrm : Form, IHasGridDataTable {
        ...
        private async void UpdateTable1() {
            ...
            switch (timeType) {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    p["capital-repay-start-time"] = startDate.Value.TruncToStart();
                    p["capital-repay-end-time"] = endDate.Value.TruncToEnd();
                    break;
                case "5":
                    p["clear-start-time"] = startDate.Value.TruncToStart();
                    p["clear-end-time"] = endDate.Value.TruncToEnd();
                    break;
            }
        ...
        private void myGridViewBinding1_GridDataTableSelectedRowChanged(object sender, MyGridDataTableSelectedRowChangedArgs e) {
            if (e.SelectedRowIndex.Length == 0) {
                ...
                btnPrjSignAgreements.Enabled = false;
                btnDebtSignAgreements.Enabled = false;
                ...
                var lockTime = Convert.ToBoolean(e.GetValue(rowIndex, "lockedTime"));
                ...
                btnPrjSignAgreements.Enabled = status >= 60;
                btnDebtSignAgreements.Enabled = status >= 90 && lockTime;
        ...
        private void btnDebtSignAgreements_Click(object sender, EventArgs e) {
            var dlg = new PrjDebtSignAgreementsDlg(myGridViewBinding1.GetSelectedValues<long>("pId").FirstOrDefault());
            dlg.StartPosition = FormStartPosition.CenterParent;
            dlg.ShowDialog(this);
        }
