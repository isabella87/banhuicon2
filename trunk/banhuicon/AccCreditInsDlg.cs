...
namespace Banhuitong.Console {
    ...
    public partial class AccCreditInsDlg : Form {
        ...
        public AccCreditInsDlg(long auId) {
            InitializeComponent();
            m_auId = auId;
        }

        private void AccCreditInsDlg_Load(object sender, EventArgs e) {
        ...
        private async void UpdateTable() {
            ...
            var p = await InvestBase.CreditIns(d);
            if (p.IsOk) {
