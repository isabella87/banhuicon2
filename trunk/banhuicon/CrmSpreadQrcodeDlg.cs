...
namespace Banhuitong.Console {
    ...
    public partial class CrmSpreadQrcodeDlg : Form {
        ...
        private void CrmSpreadQrcodeDlg_Load(object sender, EventArgs e) {
            tbRCode.Text = "班汇通推广";
#if DEBUG
            tbRegisterBaseAddress.Text = Properties.Settings.Default.Rpc_BaseUrlDebug + "/m/regist-user.html?rcode=";
#else
            tbRegisterBaseAddress.Text = Properties.Settings.Default.Rpc_BaseUrl+"/m/regist-user.html?rcode=";
#endif
        }
