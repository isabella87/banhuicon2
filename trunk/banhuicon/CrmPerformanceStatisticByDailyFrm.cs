...
namespace Banhuitong.Console {
    using MyLib.UI;
    //绩效考核-销售一部
    public partial class CrmPerformanceStatisticByDailyFrm : Form, IHasGridDataTable {
        /// <summary>
        /// key：客户经理
        /// value:部门
        /// </summary>
        ...
        public CrmPerformanceStatisticByDailyFrm() {
            InitializeComponent();
        }
        ...
        private void FrmCrmPerformanceInvest1_1_Load(object sender, EventArgs e) {
            m_Managers = new Hashtable();
            m_AllNodes = new List<TreeNode>();
            toolStrip1.AddControlAfter(searchDate, toolStripLabel1);
            searchDate.Value = DateTime.Now.AddDays(-1);
            UpdateManagersTree();
        }

        private void btnCustomers_Click(object sender, EventArgs e) {
            var dlg = new CrmCstmOfMgrByDailyDlg(myGridViewBinding1.GetSelectedValues<string>("uName").FirstOrDefault(), searchDate.Value);
