...
{
    partial class CrmInvestor3TimeOutFrm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            new MyLib.UI.MyGridColumn("ciId", "ID", MyLib.UI.MyGridColumnType.Number, 120, false, true),
            ...
            new MyLib.UI.MyGridColumn("prLevel", "等级", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            new MyLib.UI.MyGridColumn("jxStatus", "状态", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            ...
            this.Name = "CrmInvestor3TimeOutFrm";
            this.ShowIcon = false;
            this.Text = "客户管理-三部超时";
