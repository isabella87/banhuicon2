namespace Banhuitong.Console {
    partial class PrjCreditorInfoDlg {
        /// <summary>
        ...
        private void InitializeComponent() {
            ...
            new MyLib.UI.MyGridColumn("name", "签章人姓名", MyLib.UI.MyGridColumnType.Text, 100, false, true),
            new MyLib.UI.MyGridColumn("mobile", "手机号", MyLib.UI.MyGridColumnType.Text, 100, false, true),
            new MyLib.UI.MyGridColumn("signLink", "签章地址", MyLib.UI.MyGridColumnType.Text, 150, false, true),
            new MyLib.UI.MyGridColumn("email", "邮箱", MyLib.UI.MyGridColumnType.Text, 150, false, true),
            new MyLib.UI.MyGridColumn("signStatus", "状态", MyLib.UI.MyGridColumnType.Text, 100, false, true),
            new MyLib.UI.MyGridColumn("signTime", "时间", MyLib.UI.MyGridColumnType.DateTime, 120, false, true)});
            ...
            this.Name = "PrjCreditorInfoDlg";
            this.ShowIcon = false;
            this.Text = "查看债权人签章信息-";
            this.Load += new System.EventHandler(this.PrjCreditorInfoDlg_Load);
