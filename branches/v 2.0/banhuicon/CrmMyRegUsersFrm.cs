...
namespace Banhuitong.Console {
    ...
    public partial class CrmMyRegUsersFrm : Form, IHasGridDataTable {
        ...
        private void CrmMyRegUsersFrm_Load(object sender, EventArgs e) {
            ...
            toolStrip2.AddControlAfter(startDate, toolStripLabel7);
            toolStrip2.AddControlAfter(endDate, toolStripLabel8);

            var dateRange = Commons.MakeDateRange();
        ...
        private async void UpdateTable() {
            ...
            d["assign-time1"] = startDate.Value.TruncToStart();
            d["assign-time2"] = endDate.Value.TruncToEnd();
