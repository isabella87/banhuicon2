...
namespace Banhuitong.Console.Crm {
    ...
    public static class CrmInvestor {
        #region 跟进客户关系管理权限设置
        [Jurisdiction("客户关系管理", "跟进客户关系管理", "查询跟进客户列表", "20402")]
        ...
        [Jurisdiction("客户关系管理", "跟进客户关系管理", "跟进客户客户经理分配", "20406")]
        ...
        [Jurisdiction("客户关系管理", "跟进客户关系管理", "批量分配跟进客户客户经理", "20407")]
        ...
        [Jurisdiction("客户关系管理", "跟进客户关系管理", "修改跟进客户手机号", "20412")]
        ...
        [Jurisdiction("客户关系管理", "跟进客户关系管理", "查询我的跟进客户列表信息", "20414")]
        ...
        [Jurisdiction("客户关系管理", "跟进客户关系管理", "查询工作任务中已跟进的跟进情况", "20415")]
        ...
        [Jurisdiction("客户关系管理", "跟进客户关系管理", "查询工作任务中已完成工作任务的数量", "20416")]
        ...
        [Jurisdiction("客户关系管理", "注册客户关系管理", "查询分配注册客户列表", "20420")]
        ...
        [Jurisdiction("客户关系管理", "注册客户关系管理", "分配注册客户", "20422")]
        ...
        [Jurisdiction("客户关系管理", "注册客户关系管理", "快速重新分配注册客户", "20421")]
        ...
        [Jurisdiction("客户关系管理", "注册客户关系管理", "查询客户历史客户经理绑定记录", "20423")]
        ...
        #region 权限ID同为20424
        [Jurisdiction("客户关系管理", "注册客户关系管理", "查询我的注册客户列表", "20424")]
        ...
        [Jurisdiction("客户关系管理", "注册客户关系管理", "查询新增注册用户列表", "20426")]
        ...
        [Jurisdiction("客户经理管理", "基础操作", "创建推广二维码", "10110")]
        public static async Task<IResult> SpreadQRCode(IDictionary<string, object> data) {
            return await Http.Get("/reg/rcode-url", data);
        }
        #endregion
    }
}
