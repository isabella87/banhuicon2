...
namespace Banhuitong.Console.Projs {
    ...
    public static class Projects {
        ...
        public static async Task<IResult> ClosePrj(long pId) {
            return await Http.Post("/mgr/prj/" + pId + "/cancelPrj");
        }
        #endregion
        ...
        [Jurisdiction("项目", "高阶操作", "执行放款", "60170")]
        ...
        [Jurisdiction("项目", "高阶操作", "项目锁定", "60099")]
        ...
        [Jurisdiction("项目", "还款", "撤销项目还款明细", "60133")]
