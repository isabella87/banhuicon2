namespace Banhuitong.Console {
    partial class AccRunningsDlg {
        ...
        private void InitializeComponent() {
            ...
            this.toolStripLabel1.Text = "类型(&S):";
            // 
            // cbbTypes
            // 
            ...
            this.tbKeys.ToolTipText = "暂时无匹配项";
            // 
            // btnSearch
            // 
            ...
            this.dataGridView1.Size = new System.Drawing.Size(758, 404);
            ...
            new MyLib.UI.MyGridColumn("inpDate", "时间", MyLib.UI.MyGridColumnType.Date, 80, false, true),
            new MyLib.UI.MyGridColumn("traceNo", "流水号", MyLib.UI.MyGridColumnType.Text, 120, false, true),
            new MyLib.UI.MyGridColumn("txFlag", "交易类型", MyLib.UI.MyGridColumnType.Text, 100, false, true),
            new MyLib.UI.MyGridColumn("txAmount", "金额", MyLib.UI.MyGridColumnType.Money, 100, false, true),
            new MyLib.UI.MyGridColumn("currBal", "余额", MyLib.UI.MyGridColumnType.Money, 100, false, true),
            new MyLib.UI.MyGridColumn("describe", "说明", MyLib.UI.MyGridColumnType.Text, 150, false, true)});
            ...
            this.Name = "AccRunningsDlg";
            this.ShowIcon = false;
            this.Text = "收支明细-{0}";
            this.Load += new System.EventHandler(this.AccRunningsDlg_Load);
