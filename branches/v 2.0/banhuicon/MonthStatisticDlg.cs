...
namespace Banhuitong.Console {
    ...
    public partial class MonthStatisticDlg : Form {
        ...
        private async void UpdateTable() {
            ...
            var p = await DataStatistic.MonthStatistic(r);
            if (p.IsOk) {
                ...
                info = string.Format(@"<table border=1 cellspacing=0 align=center>
                        ...
                        <td {0} {1}><b>总借款人数</b></td><td {0} {2}>&nbsp;{31}</td> <td {0} {1}><b>&nbsp;</b></td><td {0} {2}>&nbsp;</td>
                        </tr><tr>
                        <td {0} {1}><b>平均借款期限(天)</b></td><td {0} {2}>&nbsp;{32}<td {0} {1}><b>平均借款利率</b></td><td {0} {2}>&nbsp;{33}%</td>
                        </tr><tr>
                        <td {0} {1}><b>个人平均借款额度(元)</b></td><td {0} {2}>&nbsp;{34}</td> <td {0} {1}><b>机构平均借款额度(元)</b></td><td {0} {2}>&nbsp;{35}</td>
                        </tr>
                        ...
                        , d.GetOrDefault<string>("borrowerCount")
                        , d.GetOrDefault<string>("averageBorrowDays"), d.GetOrDefault<decimal>("averageBorrowRate")
                        , d.GetOrDefault<string>("personAverageBorrowAmt"), d.GetOrDefault<string>("orgAverageBorrowAmt")
                        );
